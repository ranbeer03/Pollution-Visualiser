...
Command: npx gltfjsx@6.1.4 TQ3280SE_PM_NO2.gltf
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/TQ3280SE_PM_NO2.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube566.geometry} material={materials.Material} position={[0, 3.16, 0]} scale={[2, 26.28, 2]} />
    </group>
  )
}

useGLTF.preload('/TQ3280SE_PM_NO2.gltf')
