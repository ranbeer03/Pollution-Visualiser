...
Command: npx gltfjsx@6.1.4 TQ3180NE_PM_PM25.gltf
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/TQ3180NE_PM_PM25.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube545.geometry} material={materials.AAA} position={[0, 1.82, 0]} scale={[1.91, 10.16, 1.91]} />
    </group>
  )
}

useGLTF.preload('/TQ3180NE_PM_PM25.gltf')
