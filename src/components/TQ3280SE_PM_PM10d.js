...
Command: npx gltfjsx@6.1.4 TQ3280SE_PM_PM10d.gltf
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/TQ3280SE_PM_PM10d.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube458.geometry} material={materials.Material} position={[0, 16.36, 0]} scale={[2, 9.33, 2]} />
      <mesh geometry={nodes.Text007.geometry} material={nodes.Text007.material} rotation={[Math.PI / 2, 0, 0]} />
    </group>
  )
}

useGLTF.preload('/TQ3280SE_PM_PM10d.gltf')
