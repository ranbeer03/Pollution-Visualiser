...
Command: npx gltfjsx@6.1.4 TQ3281SW_PM_NO2.gltf
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/TQ3281SW_PM_NO2.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube679.geometry} material={materials.Material} position={[0, -2.55, 0]} scale={[2, 26.75, 2]} />
    </group>
  )
}

useGLTF.preload('/TQ3281SW_PM_NO2.gltf')
