...
Command: npx gltfjsx@6.1.4 TQ3281SW_PM_NOx.gltf
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/TQ3281SW_PM_NOx.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube677.geometry} material={materials.Material} position={[0, -22.56, 0]} scale={[1.92, 47.32, 1.92]} />
    </group>
  )
}

useGLTF.preload('/TQ3281SW_PM_NOx.gltf')
