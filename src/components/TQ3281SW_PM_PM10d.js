...
Command: npx gltfjsx@6.1.4 TQ3281SW_PM_PM10d.gltf
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/TQ3281SW_PM_PM10d.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube643.geometry} material={materials.AAA} position={[0, 9.96, 0]} scale={[1.92, 22.57, 1.92]} />
    </group>
  )
}

useGLTF.preload('/TQ3281SW_PM_PM10d.gltf')
