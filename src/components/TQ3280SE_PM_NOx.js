...
Command: npx gltfjsx@6.1.4 TQ3280SE_PM_NOx.gltf
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/TQ3280SE_PM_NOx.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube678.geometry} material={materials.Material} position={[0, -10.21, 0]} scale={[2, 49.26, 2]} />
    </group>
  )
}

useGLTF.preload('/TQ3280SE_PM_NOx.gltf')
