...
Command: npx gltfjsx@6.1.4 TQ3280SE_PM_PM25.gltf
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/TQ3280SE_PM_PM25.gltf')
  const rotationInRadians = 90 * (Math.PI / 180)
  return (
    <group {...props} dispose={null} rotation={[0, -rotationInRadians, 0]}>
      ...
      <mesh geometry={nodes.Cube678.geometry} material={materials.Material} position={[0, 16.36, 0]} scale={[2, 8.64, 2]} />
    </group>
  )
}

useGLTF.preload('/TQ3280SE_PM_PM25.gltf')
