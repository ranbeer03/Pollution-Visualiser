...
Command: npx gltfjsx@6.1.4 TQ3180NE_PM_PM10d.gltf
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/TQ3180NE_PM_PM10d.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube253.geometry} material={materials.AAA} position={[0, 9.59, 0]} scale={[1.93, 7.02, 1.93]} />
    </group>
  )
}

useGLTF.preload('/TQ3180NE_PM_PM10d.gltf')
