...
Command: npx gltfjsx@6.1.4 TQ3180NE_PM_NOx.gltf
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/TQ3180NE_PM_NOx.gltf')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube677.geometry} material={materials.AAA} scale={[1.92, 18.49, 1.92]} />
    </group>
  )
}

useGLTF.preload('/TQ3180NE_PM_NOx.gltf')
